            ...
            <div className='grid gap-8 lg:grid-cols-[1.1fr_1fr] items-center'>
              <div>
                ...
                <p className='mt-4 text-gray-600 text-lg'>
                  Our advanced medical gas area alarm is designed to provide
                  real-time monitoring of critical gas systems within healthcare
                  facilities. It continuously tracks the rate of flow, pressure,
                  and supply status of medical gases, ensuring safe and
                  uninterrupted delivery to patient care areas. With intelligent
                  sensors, high-accuracy detection, and instant alert
                  mechanisms, the system immediately notifies staff of any
                  abnormal conditions, leaks, or fluctuations.
                </p>
          ...
          <div className='container mx-auto px-4 md:px-6 max-w-7xl'>
            <div className='grid gap-6 sm:grid-cols-2 lg:grid-cols-3'>
              ...
              <Card className='border-2 hover:border-blue-200 transition-colors'>
                ...
                <CardContent className='pt-0'>
                  <CardDescription>
                    Low-latency monitoring of gas systems, ensuring timely
                    detection of leaks, fluctuations, and supply issues.
                  </CardDescription>
                </CardContent>
              </Card>
              <Card className='border-2 hover:border-blue-200 transition-colors'>
              ...
              <CardContent className='pt-0'>
                <ul className='space-y-3'>
                  <li className='flex items-start'>
                    ...
                    <span>
                      Smart Medical Gas Area Alarm actively monitors your gas on
                      highly visible 7”/10”/15” TFT LCD Touch Screen.
                    </span>
                  </li>
                  <li className='flex items-start'>
                    <CheckCircle className='h-4 w-4 text-green-600 mt-0.5 mr-2 flex-shrink-0' />
                    <span>
                      It comes with Wi-Fi communication, Alerts can be sent via
                      Email, Message, Telephone call to the maintenance engineer
                      or Operator for proactive monitoring.
                    </span>
                  </li>
                  <li className='flex items-start'>
                    <CheckCircle className='h-4 w-4 text-green-600 mt-0.5 mr-2 flex-shrink-0' />
                    <span>
                      Monitor gas pressure low & high set points, real-time
                      alerting for any abnormalities
                    </span>
                  </li>
                  <li className='flex items-start'>
                    <CheckCircle className='h-4 w-4 text-green-600 mt-0.5 mr-2 flex-shrink-0' />
                    <span>Building management Software (BMS) compatible</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
              ...
              <CardContent className='pt-0'>
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                  <SpecItem
                    ...
                    label='Display Sizes'
                    value={"Wide range of 7”/10”/15” TFT LCD Touch Screen."}
                  />
                  <SpecItem
              ...
              <CardContent className='pt-0'>
                <ul className='space-y-2 text-sm'>
                  <li className='flex items-center'>
                    ...
                    Type: Oxygen (O2), Nitrous Oxide (N2O), Carbon Dioxide
                    (CO2), Nitrogen (N2), Medical Air4 (Air4), Medical
                    Air7(Air7), Vacuum(Va), Agss(Ag)
                  </li>
                  <li className='flex items-center'>
