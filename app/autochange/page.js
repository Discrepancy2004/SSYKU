...
export default function AutoChangeOverUnit() {
  const less = "<"
  return (
            ...
            <div className='grid gap-8 lg:grid-cols-[1.1fr_1fr] items-center'>
              <div>
                ...
                <p className='mt-4 text-gray-600 text-lg'>
                  Dew Point Monitor Our dew point monitor provides high-accuracy
                  measurement of humidity and temperature, helping facilities
                  maintain controlled and stable environments.Built with durable
                  sensors and intelligent monitoring technology, it delivers
                  consistent results even in demanding conditions.
                </p>
          ...
          <div className='container mx-auto px-4 md:px-6 max-w-7xl'>
            <div className='grid gap-6 sm:grid-cols-2 lg:grid-cols-3'>
              ...
              <Card className='border-2 hover:border-blue-200 transition-colors'>
                ...
                <CardContent className='pt-0'>
                  <CardDescription>
                    Low-latency monitoring of Temperature and Humidity
                  </CardDescription>
                </CardContent>
              </Card>
              <Card className='border-2 hover:border-blue-200 transition-colors'>
            ...
            <Card>
              ...
              <CardContent className='pt-0'>
                <ul className='space-y-3'>
                  ...
                  <li className='flex items-start'>
                    <CheckCircle className='h-4 w-4 text-green-600 mt-0.5 mr-2 flex-shrink-0' />
                    <span>Dew point sensor down to -60 degree Celsius</span>
                  </li>
                  <li className='flex items-start'>
                    <CheckCircle className='h-4 w-4 text-green-600 mt-0.5 mr-2 flex-shrink-0' />
                    <span>
                      Sensor can be installed in a pressurized system up to 80
                      bar (1 160 psi)
                    </span>
                  </li>
                  <li className='flex items-start'>
                    <CheckCircle className='h-4 w-4 text-green-600 mt-0.5 mr-2 flex-shrink-0' />
                    <span>
                      Device is mainly designed to monitor, measure and record
                      data for analysis
                    </span>
                  </li>
                </ul>
          ...
          <div className='container mx-auto px-4 md:px-6 max-w-7xl grid gap-8 lg:grid-cols-3'>
              ...
              <CardContent className='pt-0'>
                <ul className='space-y-2 text-sm'>
                  <li className='flex items-center'>
                    ...
                    Monolithic measuring cell type HMC200, manufactured in
                    thin-film technology.
                  </li>
                  <li className='flex items-center'>
                    <CheckCircle className='h-3 w-3 text-green-600 mr-2' />
                    Integrated auto-calibration procedure enables a measurement
                    accuracy of f {less}2 °C Td ({less}3.6 °F Td)
                  </li>
                  <li className='flex items-center'>
                    <CheckCircle className='h-3 w-3 text-green-600 mr-2' />{" "}
            ...
            <Card className='border-2'>
              ...
              <CardContent className='pt-0'>
                <ul className='space-y-2 text-sm'>
                  <li className='flex items-center'>
                    <CheckCircle className='h-3 w-3 text-green-600 mr-2' /> Dew
                    Point Sensor
                  </li>
                </ul>
              </CardContent>
